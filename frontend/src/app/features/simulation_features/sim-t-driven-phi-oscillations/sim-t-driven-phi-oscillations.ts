...
@Component({
    selector: 'app-sim-t-driven-phi-oscillations',
    imports: [FormsModule],
    templateUrl: './sim-t-driven-phi-oscillations.html',
    styleUrl: './sim-t-driven-phi-oscillations.css',
    host: { ngSkipHydration: 'true' },
})
export class SimTDrivenPhiOscillations implements OnInit, AfterViewInit, OnDestroy {
    ...
    private drawRotPendulum(angle: number, motorAngle: number) {
        ...
        this.ctxRot.beginPath(); this.ctxRot.fillStyle = 'black';
        ...
        this.ctxRot.beginPath(); this.ctxRot.fillStyle = '#ff6666';
