...
@Component({
    selector: 'app-sim-t-free-oscillations',
    imports: [FormsModule],
    templateUrl: './sim-t-free-oscillations.html',
    styleUrl: './sim-t-free-oscillations.css',
    host: { ngSkipHydration: 'true' },
})
export class SimTFreeOscillations implements OnInit, AfterViewInit, OnDestroy {
    ...
    goForward() { this.router.navigate(['/decision/dec-t-damped']); }
